...
`<img src="http://www.forkosh.com/mathtex.cgi? \Large E(w)=\frac{1}2\sum_{n=1}^N \left\{y(x_n,w)}-t_n\right\}^2">">`

<img src="http://www.forkosh.com/mathtex.cgi? \Large E(w)=\frac{1}2\sum_{n=1}^N \left\{y(x_n,w)}-t_n\right\}^2">

2. Google chart 服务器方法

`<img src="http://chart.googleapis.com/chart?cht=tx&chl=\Large E(w)=\frac{1}2\sum_{n=1}^N \left\{y(x_n,w)}-t_n\right\}^2" style="border:none;">`

<img src="http://chart.googleapis.com/chart?cht=tx&chl=\Large E(w)=\frac{1}2\sum_{n=1}^N \left\{y(x_n,w)}-t_n\right\}^2" style="border:none;">

**求问:google chart返回的公式里tn右边多了右键头?百思不得其解**